    ...
    <footer className="cream-panel relative mt-auto">
      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-5 px-8 py-8 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          ...
          <p className="max-w-[18rem] text-[12.5px] font-normal leading-relaxed text-[#000000]/70">
            Private money on Stellar. Bridge in, hold, pay and trade — proven on-chain, never revealed.
          </p>
        </div>
        <div className="flex flex-wrap items-center gap-x-6 gap-y-2 font-mono text-[11px] uppercase tracking-[0.16em] text-[#000000]/55">
          <NavLink to="/faucet" className="transition hover:text-[#000000]">
            Faucet
          </NavLink>
          <button type="button" onClick={() => void clearLocalData()} className="uppercase transition hover:text-[#000000]">
            Clear data
          </button>
          <span className="text-[#000000]/45">© Obscura 2026</span>
        </div>
      </div>
    </footer>
  )
